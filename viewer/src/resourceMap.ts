// Texture alias → file mapping, vendored from the renderer repo's
// demo (demo/src/config/resourceMap.js, ISC license — the metadata
// package ships the images but this mapping lives only in the demo).
// Values point at dist/assets/, where the build copies
// @screeps/renderer-metadata/images.
...
export const resourceMap: Record<string, string> = Object.fromEntries(
  Object.entries(files).map(([alias, file]) => [alias, `assets/${file}`]),
);
